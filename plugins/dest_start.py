...
async def start_command(client: Client, message: Message):
    ...
    if len(text)>7:
        ...
        reply_markup = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("Channel", url = "https://telegram.me/TellyFun_Official"),
                    InlineKeyboardButton("Group Owner", url = "https://telegram.me/KDramasFlix")
                ]
            ]
        )
...
async def send_text(client: Bot, message: Message):
    if message.reply_to_message:
        ...
        pls_wait = await message.reply("<i>Broadcasting the Message.... It will take some time</i>")

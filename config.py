...
# Dest Bot token @Botfather
DEST_BOT_TOKEN = os.environ.get("DEST_BOT_TOKEN", "your-token-here")
...
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "<b>🎬Jᴏɪɴ ᴜs :<a href='https://t.me/TellyFun_Official'>[TellyFun]</a></b>")
